/*
===============================================================================
DDL Script: Create Gold Materialized Views (PostgreSQL version)
===============================================================================
Script Purpose:
    This script creates **materialized views** for the Gold layer 
    in the data warehouse (Star Schema).

    Materialized views are used instead of normal views to improve 
    dashboard performance by caching precomputed results.
===============================================================================
*/
